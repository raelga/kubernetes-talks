...
timeout 60 sh -c 'until nc -z $0 $1; do echo "Waiting for port 22 availability"; sleep 10; done' $(terraform output -raw host) 22
sleep 30
# Connect to the instance
echo "Connect to the instance using:"
echo
echo "ssh -tt -o StrictHostKeyChecking=no -i ${HOME}/.ssh/labsuser.pem $(terraform output -raw ssh_host)"
